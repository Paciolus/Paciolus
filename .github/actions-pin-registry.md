...
- `actions/checkout` v6 — `ci.yml`, `backup-integrity-check.yml`
- `actions/checkout` v4 — `dr-test-monthly.yml`
- `actions/setup-python` v6 — `ci.yml`, `backup-integrity-check.yml`
- `actions/setup-node` v6 — `ci.yml`
- `actions/upload-artifact` v6 — `ci.yml`, `backup-integrity-check.yml`
