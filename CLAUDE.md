...
- **Tier Cleanup:** Enterprise → Organization Consolidation — "Enterprise" display name retired in favor of "Organization" across all frontend pages. Pricing page: 3-card layout (Solo/Team/Organization), self-serve checkout, comparison table, FAQ. ToolShowcase/ToolSlideshow updated. Trust/contact/terms pages use "Organization" consistently. No duplicate Enterprise/Organization entries remain. **Commits: 561c73c, (fixup)**
- **Sprint 452: Proposal C "Audit Maturity" Pricing Restructure** — Progressive capability unlock: Solo (individual analysis, 7 tools, PDF export, $50/$500), Team (firm-wide testing, 11 tools, PDF+Excel+CSV, 100 uploads/mo, 50 clients, $150/$1,500), Organization (enterprise compliance, all 12+ tools, 15 seats included up to 75, $450/$4,500). Backend: entitlements restructured (_TEAM_TOOLS/FORMATS sets, Solo excel/csv export removed, Team finite limits, Org seats_included=15/max_team_seats=75), price_config updated (Team $150/$1,500, Org $450/$4,500, Org flat seat pricing $55/$550), billing route tier-aware seat validation + Org checkout support. Frontend: UpgradeGate 3-tier tool mapping + revenue-testing/bank-rec gates, command palette organization tier + 3-tier toolGuard, checkout Org support (15 base seats, $55/seat flat), pricing page updated (tool counts, seat info, comparison table, FAQ), ToolShowcase 3-tier reclassification, UpgradeModal Org tier + Solo/Team fixes. Tests: 249 across 3 files (42 entitlements + 32 price config + 175 launch validation).
...
- Solo/Team/Organization user tiers with progressive capability unlock: Solo ($50/$500, 7 tools, PDF export), Team ($150/$1,500, 11 tools, all exports), Organization ($450/$4,500, all tools, 15 seats included). Free tier exists as default, not marketed.
