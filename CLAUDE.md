...
- **Tier Cleanup:** Enterprise/Organization → Solo/Team Consolidation — Enterprise card removed from pricing page (3-col→2-col), comparison table reduced to Solo/Team, Enterprise FAQ removed, Organization/Enterprise plan cards removed from ToolShowcase + ToolSlideshow, trust page DPA links updated (enterprise→team), contact page inquiry type Enterprise→Sales, terms page Enterprise tier row removed, stale Organization/Enterprise comments cleaned (9 files, -149/+65 lines). **Commit: 561c73c**
...
- Solo/Team user tiers (Free tier exists as default, not marketed)
