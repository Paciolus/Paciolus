...
- **Tier Cleanup:** Enterprise → Organization Consolidation — "Enterprise" display name retired in favor of "Organization" ($400/$4,000) across all frontend pages. Pricing page: 3-card layout (Solo/Team/Organization), self-serve checkout, comparison table, FAQ. ToolShowcase/ToolSlideshow updated. Trust/contact/terms pages use "Organization" consistently. No duplicate Enterprise/Organization entries remain. **Commits: 561c73c, (fixup)**
...
- Solo/Team/Organization user tiers (Free tier exists as default, not marketed)
