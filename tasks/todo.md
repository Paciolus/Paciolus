...
### Deferred to Phase XVIII+

| Feature | Reason | Earliest Phase |
|---------|--------|----------------|
| Budget Variance Deep-Dive | Multi-Period page tab refactor prerequisite | Phase XVIII |
| Accrual Reasonableness Testing (Tool 12) | Dual-input fuzzy matching complexity | Phase XVIII |
| Intercompany Transaction Testing (Tool 13) | Cycle-finding algorithm; narrow applicability | Phase XVIII |
| Multi-Currency Conversion | Cross-cutting 11+ engine changes; needs dedicated RFC | Phase XVIII |
| Engagement Templates | Premature until engagement workflow has real user feedback | Phase XVIII |
| Lease Accounting (ASC 842) | 8/10 complexity; high value but needs research sprint | Phase XVIII |
| Cash Flow Projector | Requires AR/AP aging + payment history | Phase XVIII |
| Cash Flow — Direct Method | Requires AP/payroll detail integration | Phase XVIII |
| Related Party Transaction Screening | Needs external data APIs; 8/10 complexity | Phase XVIII+ |
| Finding Attachments | File storage contradicts Zero-Storage philosophy | Phase XVIII+ |
| Real-Time Collaboration | WebSocket infrastructure; 9/10 complexity | Phase XVIII+ |
| Custom Report Builder | Rich text editor + templating engine | Phase XVIII+ |
| Historical Engagement Comparison | Requires persistent aggregated data | Phase XVIII+ |
| User-toggleable dark/light mode | CEO vision is route-based, not preference | Phase XVIII (if demand) |
| Homepage redesign | Homepage stays dark; separate initiative | Phase XVIII |
| Mobile hamburger menu for ToolNav | Current overflow dropdown sufficient | Phase XVIII |
| Print stylesheet | Out of scope for completed phases | Phase XVIII |
| Component library / Storybook | Lower priority than shipping features | Phase XVIII |
| Onboarding flow | UX research needed | Phase XVIII |
| Batch export all memos | ZIP already bundles anomaly summary | Phase XVIII |
