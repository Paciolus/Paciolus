...
> API Integration Hardening: 102 Pydantic response schemas (32 diagnostic + 64 testing + 6 engagement/settings), apiClient 422 parsing for Pydantic detail arrays, isAuthError checks in 3 hooks, downloadBlob migration (lib → apiClient), CSRF on logout, UI state consistency (retry buttons, theme tokens, loading text, role="alert"), 74 API contract tests, OpenAPI→TypeScript generation infrastructure. **Tests: 2,977 backend + 128 frontend.**

> **Detailed checklists:** `tasks/archive/phases-vi-ix-details.md` | `tasks/archive/phases-x-xii-details.md` | `tasks/archive/phases-xiii-xvii-details.md` | `tasks/archive/phase-xviii-details.md` | `tasks/archive/phases-xix-xxiii-details.md` | `tasks/archive/phases-xxiv-xxvi-details.md` | `tasks/archive/phase-xxvii-details.md` | `tasks/archive/phase-xxviii-details.md` | `tasks/archive/phase-xxix-details.md`
...
- [x] `npm run build` — passes (36 routes)
- [x] CLAUDE.md: Phase XXIX summary added, status COMPLETE, test count → 2,977
- [x] Archive detailed checklists to `tasks/archive/phase-xxix-details.md`
- [x] todo.md: Phase XXIX detailed section → summary in Completed Phases
