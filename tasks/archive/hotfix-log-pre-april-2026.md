# Hotfix log — pre-April 2026

Archived 2026-04-29. These are the pre-April 2026 entries from `tasks/todo.md::Hotfixes`. April 2026 onward stays in `tasks/todo.md`.
