# 🌅 Paciolus Overnight Brief — 2026-04-29
**Overall Status:** 🔴 RED
**Report generated:** 04:00 AM | **Agents run:** 6/6

Backend: 8486 passed / 0 failed in 748.6s. Frontend: 1957 passed / 0 failed in 56.6s. 4 failure(s) resolved. Meridian tests: 2 passed, 0 failed. 0/7 known bugs confirmed open. Found 0 leads across 5 themes. Top platform: none. Highest urgency:  19 commits in last 24h, 75 in last 7d. Backend: 17 outdated. Frontend: 4 outdated. 3 security-relevant packages have updates. 1 deferred. Backend coverage: 93.13% (94,164/101,107 statements, 6,943 uncovered). 7-day mean: 92.76% (+0.37pp). Non-production excluded: 3 file(s).

---

## 🧪 QA Warden — 🟢 GREEN
**Backend:** 8486 passed, 0 failed (748.6s)  
**Frontend:** 1957 passed, 0 failed (56.6s)  
...
**Backend line coverage:** 93.13% (94,164/101,107 statements, 6,943 uncovered)  
**7-day mean:** 92.76%  |  **Delta:** ↑ +0.37pp  
...
**Commits (24h):** 19 | **Commits (7d):** 75  
**Work breakdown (24h):** other: 7, audit: 1, bug fix: 6, report: 3, ui: 2  

---

## 📦 Dependency Sentinel — 🔴 RED
**Backend outdated:** 17 packages | **Frontend outdated:** 4 packages  
...
---
*Next run: tomorrow at 2:00 AM | Output: reports/nightly/2026-04-30.md*
---
