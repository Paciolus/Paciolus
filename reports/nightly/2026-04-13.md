# 🌅 Paciolus Overnight Brief — 2026-04-13
**Overall Status:** 🟡 YELLOW
**Report generated:** 04:00 AM | **Agents run:** 5/5

Backend: 7392 passed / 0 failed in 563.5s. Frontend: 1757 passed / 0 failed in 56.5s. Meridian tests: 2 passed, 0 failed. 0/7 known bugs confirmed open. Found 0 leads across 5 themes. Top platform: none. Highest urgency:  0 commits in last 24h, 29 in last 7d. Backend: 25 outdated. Frontend: 0 outdated. 4 security-relevant packages have updates. 1 deferred.

---

## 🧪 QA Warden — 🟢 GREEN
**Backend:** 7392 passed, 0 failed (563.5s)  
**Frontend:** 1757 passed, 0 failed (56.5s)  
...
**Backend outdated:** 25 packages | **Frontend outdated:** 0 packages  
...
| chardet | 7.4.0.post2 | 7.4.2 | patch |  |
| charset-normalizer | 3.4.6 | 3.4.7 | patch |  |
| click | 8.3.1 | 8.3.2 | patch |  |
| cryptography | 46.0.6 | 46.0.7 | patch |  |
| fastapi | 0.135.2 | 0.135.3 | patch |  |
| hypothesis | 6.151.10 | 6.151.13 | patch |  |
...
---
*Next run: tomorrow at 2:00 AM | Output: reports/nightly/2026-04-14.md*
---
