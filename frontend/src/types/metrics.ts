...
export const RATIO_METRICS: Record<string, MetricInfo> = {
  ...
  // Sprint 492: Activity / Cash-Cycle Ratios
  dso: {
    key: 'dso',
    displayName: 'Days Sales Outstanding',
    formula: '(Accounts Receivable ÷ Revenue) × 365',
    description: 'Average days to collect payment after a sale',
    standardNote: 'Revenue recognition timing (ASC 606/IFRS 15) affects result',
    valuePrefix: '',
    valueSuffix: ' days',
    higherIsBetter: false,
    category: 'efficiency',
  ...
  dio: {
    ...
    standardNote: 'LIFO (US GAAP) vs FIFO/weighted average (IFRS) affects comparability',
    valuePrefix: '',
    valueSuffix: ' days',
    higherIsBetter: false,
    category: 'efficiency',
  ...
  ccc: {
    ...
    formula: 'DIO + DSO − DPO',
    description: 'Total days from cash outlay to cash receipt; negative means cash collected before supplier payment',
    valuePrefix: '',
    valueSuffix: ' days',
    higherIsBetter: false,
    category: 'efficiency',
  ...
  // Sprint 492: Extended Solvency & Turnover Ratios
  equity_ratio: {
    key: 'equity_ratio',
    displayName: 'Equity Ratio',
    formula: 'Total Equity ÷ Total Assets',
    description: 'Proportion of assets financed by shareholders',
    valuePrefix: '',
    valueSuffix: 'x',
    higherIsBetter: true,
    category: 'leverage',
  ...
  long_term_debt_ratio: {
    key: 'long_term_debt_ratio',
    displayName: 'Long-Term Debt Ratio',
    formula: '(Total Liabilities − Current Liabilities) ÷ Total Assets',
    description: 'Proportion of assets financed by long-term debt',
    valuePrefix: '',
    valueSuffix: 'x',
    higherIsBetter: false,
    category: 'leverage',
  ...
  inventory_turnover: {
    ...
    description: 'Times inventory is sold and replaced per period',
    standardNote: 'LIFO (US GAAP) vs FIFO/weighted average (IFRS) affects comparability',
    valuePrefix: '',
    valueSuffix: 'x',
    higherIsBetter: true,
  ...
  receivables_turnover: {
    ...
    description: 'Times receivables are collected per period',
    valuePrefix: '',
    valueSuffix: 'x',
    higherIsBetter: true,
    category: 'efficiency',
