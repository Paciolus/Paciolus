 ...
 *
 * Sprint 281: Phase XXXVIII — catches errors in /about, /approach,
 * /contact, /pricing, /privacy, /terms, /trust pages.
 *
 * Renders on the dark theme (marketing pages are vault exterior).
 */
    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="max-w-md w-full text-center">
        ...
        <p className="text-content-secondary mb-8 leading-relaxed">
          Something went wrong loading this page. Please try again or
