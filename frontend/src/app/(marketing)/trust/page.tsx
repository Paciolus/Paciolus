...
const downloadableArtifacts: DownloadableArtifact[] = [
  ...
  { label: 'Request DPA', description: 'Data Processing Agreement available for Organization accounts.', href: '/contact?inquiry_type=organization', icon: 'file-download', type: 'Organization' },
]
    ...
    <div>
      ...
      >
        ...
        <motion.div variants={fadeUp} className="text-center mt-10">
          <Link
            href="/contact?inquiry_type=organization"
...
export default function TrustAndSecurity() {
  return (
    <div className="relative z-10 min-h-screen bg-gradient-obsidian">
      ...
      {/* ── Section 5: Incident-Preparedness Playbook ────────── */}
      <ModuleSection
        id="playbook"
