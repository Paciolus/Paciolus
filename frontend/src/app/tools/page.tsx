...
const TOOLS: ToolDef[] = [
  ...
  { key: 'ap_testing', label: 'AP Payment Testing', href: '/tools/ap-testing', description: 'Test AP payment registers for duplicate payments, vendor anomalies, ghost vendors, and fraud indicators.', reference: 'ISA 500 Substantive Testing', category: 'Testing Suite', testCount: 14 },
  { key: 'revenue_testing', label: 'Revenue Testing', href: '/tools/revenue-testing', description: 'Analyze revenue GL extracts for recognition anomalies per ISA 240, ASC 606, and IFRS 15 contract standards.', reference: 'ISA 240 / ASC 606 / IFRS 15', category: 'Testing Suite', testCount: 18 },
  { key: 'ar_aging', label: 'AR Aging', href: '/tools/ar-aging', description: 'Analyze accounts receivable aging schedules for collectibility risks, concentration, and unusual patterns.', reference: 'ISA 540 Accounting Estimates', category: 'Testing Suite', testCount: 12 },
  { key: 'payroll_testing', label: 'Payroll Testing', href: '/tools/payroll-testing', description: 'Test payroll registers for ghost employees, rate anomalies, overtime spikes, and segregation issues.', reference: 'ISA 240 Fraud Indicators', category: 'Testing Suite', testCount: 13 },
  { key: 'fixed_asset_testing', label: 'Fixed Assets', href: '/tools/fixed-assets', description: 'Test fixed asset registers for depreciation accuracy, impairment indicators, disposals, and lease indicators.', reference: 'ISA 500 / IAS 16 / ASC 360', category: 'Testing Suite', testCount: 11 },
  { key: 'inventory_testing', label: 'Inventory Testing', href: '/tools/inventory-testing', description: 'Analyze inventory records for valuation anomalies, obsolescence indicators, and cutoff issues.', reference: 'ISA 501 / IAS 2 / ASC 330', category: 'Testing Suite', testCount: 10 },
  // Advanced
