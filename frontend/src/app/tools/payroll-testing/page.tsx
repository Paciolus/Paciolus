      ...
      <div className="pt-24 pb-16 px-6 max-w-5xl mx-auto">
        ...
        {status === 'success' && result && (
          ...
          >
            ...
            <div>
              <h2 className="font-serif text-lg text-oatmeal-200 mb-4">Flagged Employees</h2>
            ...
            <div className="bg-obsidian-800/30 border border-obsidian-600/20 rounded-xl p-4 mt-8">
              <p className="font-sans text-xs text-oatmeal-600 leading-relaxed">
                <span className="text-oatmeal-500 font-medium">Disclaimer:</span> This automated payroll testing
