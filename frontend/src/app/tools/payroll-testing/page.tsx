...
export default function PayrollTestingPage() {
  ...
  return (
    <main className="min-h-screen bg-surface-page">
      <ToolNav currentTool="payroll-testing" />
      ...
      <div className="pt-24 pb-16 px-6 max-w-5xl mx-auto">
        ...
        {!authLoading && !isAuthenticated && (
          ...
          >
            ...
            <p className="font-sans text-content-secondary text-sm mb-6 max-w-md mx-auto">
              Payroll & Employee Testing requires a verified account. Sign in or create a free account to analyze your payroll data.
            </p>
        ...
        {status === 'success' && result && (
          ...
          >
            ...
            <div>
              <h2 className="font-serif text-lg text-content-primary mb-4">Flagged Employees</h2>
            ...
            <div className="bg-surface-card-secondary border border-theme rounded-xl p-4 mt-8">
              <p className="font-sans text-xs text-content-tertiary leading-relaxed">
                <span className="text-content-secondary font-medium">Disclaimer:</span> This automated payroll testing
