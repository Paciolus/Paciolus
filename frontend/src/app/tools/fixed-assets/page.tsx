...
export default function FixedAssetTestingPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-obsidian">
      <ToolNav currentTool="fixed-assets" />
      ...
      <div className="pt-24 pb-16 px-6 max-w-5xl mx-auto">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-sage-500/10 border border-sage-500/20 mb-6">
            ...
            <span className="text-sage-300 text-sm font-sans font-medium">IAS 16 / ISA 540 PP&amp;E Analysis</span>
          </div>
        ...
        {status === 'success' && result && (
          ...
          >
            ...
            <div>
              <h2 className="font-serif text-lg text-oatmeal-200 mb-4">Flagged Fixed Assets</h2>
            ...
            <div className="bg-obsidian-800/30 border border-obsidian-600/20 rounded-xl p-4 mt-8">
              <p className="font-sans text-xs text-oatmeal-600 leading-relaxed">
                <span className="text-oatmeal-500 font-medium">Disclaimer:</span> This automated fixed asset testing
