    ...
    <main className="min-h-screen bg-gradient-obsidian">
      ...
      <nav className="fixed top-0 w-full bg-obsidian-900/80 backdrop-blur-md border-b border-obsidian-600/50 z-50">
        <div className="max-w-4xl mx-auto px-6 py-3 flex justify-between items-center">
          ...
          <span className="text-oatmeal-400 text-sm font-sans">
            Settings
          </span>
        </div>
      </nav>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-2 text-oatmeal-500 text-sm font-sans mb-4">
              ...
              <span>/</span>
              <span className="text-oatmeal-300">Settings</span>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <Link
                ...
                className="block card hover:border-sage-500/50 transition-all group"
              >
                <div className="flex items-center gap-4 mb-4">
                  <div className="w-12 h-12 bg-sage-500/20 rounded-xl flex items-center justify-center group-hover:bg-sage-500/30 transition-colors">
                    <svg className="w-6 h-6 text-sage-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                    </svg>
                  </div>
                  <div>
                    <h2 className="text-lg font-serif font-semibold text-oatmeal-200 group-hover:text-sage-300 transition-colors">
                      Profile Settings
                    </h2>
                ...
                <ul className="space-y-2 text-sm text-oatmeal-400 font-sans">
                  <li className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 bg-oatmeal-600 rounded-full"></span>
                    Display name
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 bg-oatmeal-600 rounded-full"></span>
