...
export default function ProfileSettingsPage() {
  ...
  // Input styling
  const inputClasses = 'w-full px-4 py-3 bg-obsidian-800 border-2 border-obsidian-500 rounded-lg text-oatmeal-200 font-sans transition-all duration-200 outline-none focus:border-sage-500 focus:ring-2 focus:ring-sage-500/20'
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-2 text-oatmeal-500 text-sm font-sans mb-4">
              ...
              <span>/</span>
              <span className="text-oatmeal-300">Profile Settings</span>
            </div>
          ...
          >
            ...
            {/* Profile Messages */}
            {profileError && (
              <div className="mb-4 p-3 bg-clay-500/10 border border-clay-500/30 rounded-lg">
                <p className="text-clay-400 text-sm font-sans">{profileError}</p>
              </div>
            )}
            {profileSuccess && (
              <div className="mb-4 p-3 bg-sage-500/10 border border-sage-500/30 rounded-lg">
                <p className="text-sage-400 text-sm font-sans">Profile updated successfully!</p>
              </div>
            )}
            ...
            <div className="mb-4">
              ...
              />
              <p className="text-oatmeal-500 text-xs mt-1">
            ...
            <button
              ...
              className="px-6 py-2.5 bg-sage-500/20 border border-sage-500/30 rounded-lg text-sage-400 font-sans font-medium hover:bg-sage-500/30 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          >
            ...
            {passwordError && (
              <div className="mb-4 p-3 bg-clay-500/10 border border-clay-500/30 rounded-lg">
                <p className="text-clay-400 text-sm font-sans">{passwordError}</p>
              </div>
            )}
            {passwordSuccess && (
              <div className="mb-4 p-3 bg-sage-500/10 border border-sage-500/30 rounded-lg">
                <p className="text-sage-400 text-sm font-sans">Password changed successfully!</p>
              </div>
            )}
            ...
            <div className="mb-6">
              ...
              />
              {confirmPassword && newPassword !== confirmPassword && (
                <p className="text-clay-400 text-xs mt-1">Passwords do not match</p>
              )}
            </div>
          ...
          >
            ...
            <div className="space-y-3 text-sm font-sans">
              ...
              <div className="flex justify-between">
                <span className="text-oatmeal-500">Member Since</span>
