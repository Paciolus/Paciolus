        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {howItWorksSteps.map((step, idx) => (
              ...
              >
                <span className="font-mono text-lg text-sage-400 flex-shrink-0 w-8 h-8 rounded-full bg-sage-500/15 flex items-center justify-center">
                  {idx + 1}
                </span>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {securityAdvantages.map((advantage) => (
              ...
              >
                <div className="flex-shrink-0 w-10 h-10 rounded-full bg-sage-500/15 flex items-center justify-center">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-obsidian-800 border border-oatmeal-500/20 rounded-lg p-8">
            <div className="flex items-start gap-4 mb-6">
              <div className="flex-shrink-0 w-10 h-10 rounded-full bg-clay-500/15 flex items-center justify-center">
