...
import type { PayrollCompositeScore, PayrollRiskTier } from '@/types/payrollTesting'
import { RISK_TIER_COLORS, RISK_TIER_LABELS } from '@/types/payrollTesting'

const tierLeftBorder: Record<PayrollRiskTier, string> = {
  low: 'border-l-4 border-l-sage-500',
  elevated: 'border-l-4 border-l-oatmeal-500',
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <p className="font-sans text-content-secondary text-sm mb-4">
            {score.tests_run} tests analyzed {score.total_entries.toLocaleString()} employees
          </p>
