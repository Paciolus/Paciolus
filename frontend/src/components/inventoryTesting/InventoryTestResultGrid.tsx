...
export function InventoryTestResultGrid({ results }: InventoryTestResultGridProps) {
  ...
  return (
    <div className="space-y-6">
      {structural.length > 0 && (
        <div>
          <h3 className="font-serif text-sm text-oatmeal-300 mb-3">Structural Tests (IN-01 to IN-03)</h3>
      ...
      {statistical.length > 0 && (
        <div>
          <h3 className="font-serif text-sm text-oatmeal-300 mb-3">Statistical Tests (IN-04 to IN-07)</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {statistical.map((r) => (
              <InvTestResultCard key={r.test_key} result={r} />
            ))}
      ...
      {advanced.length > 0 && (
        <div>
          <h3 className="font-serif text-sm text-oatmeal-300 mb-3">Advanced Tests (IN-08 to IN-09)</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {advanced.map((r) => (
              <InvTestResultCard key={r.test_key} result={r} />
            ))}
