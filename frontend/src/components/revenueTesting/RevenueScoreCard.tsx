...
import type { RevenueCompositeScore, RevenueRiskTier } from '@/types/revenueTesting'
import { RISK_TIER_COLORS, RISK_TIER_LABELS } from '@/types/revenueTesting'

const tierBorderAccent: Record<RevenueRiskTier, string> = {
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <p className="font-sans text-content-secondary text-sm mb-4">
            {score.tests_run} tests analyzed {score.total_entries.toLocaleString()} revenue entries
          </p>
