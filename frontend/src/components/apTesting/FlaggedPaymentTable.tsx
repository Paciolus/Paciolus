...
export function FlaggedPaymentTable({ results }: FlaggedPaymentTableProps) {
  ...
  if (allFlagged.length === 0) {
    return (
      <div className="bg-surface-card-secondary border border-theme rounded-xl p-8 text-center">
        <p className="font-sans text-content-secondary">No flagged payments found. All tests returned clean results.</p>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Table */}
      <div className="overflow-x-auto bg-surface-card border border-theme shadow-theme-card rounded-xl">
