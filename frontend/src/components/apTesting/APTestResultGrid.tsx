                      ...
                      <div className="min-w-0">
                        <p className="font-sans text-xs text-oatmeal-300 truncate">
                          ...
                          {fe.entry.invoice_number && (
                            <span className="text-oatmeal-600 ml-2">#{fe.entry.invoice_number}</span>
                          )}
                        </p>
  ...
  return (
    <div className="space-y-6">
      ...
      {statistical.length > 0 && (
        <div>
          <h3 className="font-serif text-sm text-oatmeal-300 mb-3">Statistical Tests (T6-T10)</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {statistical.map((r) => (
              <APTestResultCard key={r.test_key} result={r} />
            ))}
      ...
      {advanced.length > 0 && (
        <div>
          <h3 className="font-serif text-sm text-oatmeal-300 mb-3">Fraud Indicators (T11-T13)</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {advanced.map((r) => (
              <APTestResultCard key={r.test_key} result={r} />
            ))}
