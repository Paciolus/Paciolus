...
const tierBorderColors: Record<JERiskTier, string> = {
...
export function JEScoreCard({ score }: JEScoreCardProps) {
  ...
  return (
    <motion.div
      ...
      className={`relative overflow-hidden rounded-2xl bg-surface-card border border-theme border-l-4 ${tierBorderColors[tier]} p-8 shadow-theme-card`}
    >
      <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <p className="font-sans text-content-tertiary text-sm mb-4">
