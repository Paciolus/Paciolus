...
function RollingMetricCard({
  ...
  return (
    ...
    >
      ...
      {/* Rolling Average */}
      {rollingAvg && (
        <div className="mb-3 p-2 bg-oatmeal-50 rounded-sm">
  ...
  return (
    <div className="animate-pulse">
      <div className="flex items-center justify-between mb-4">
        <div className="h-6 w-48 bg-oatmeal-200 rounded-sm" />
        <div className="flex gap-2">
          {[1, 2, 3].map((i) => (
            <div key={i} className="h-8 w-20 bg-oatmeal-200 rounded-sm" />
          ))}
        </div>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {[1, 2, 3, 4, 5, 6].map((i) => (
          <div key={i} className="border border-oatmeal-200 rounded-lg p-4">
            <div className="h-4 w-24 bg-oatmeal-200 rounded-sm mb-3" />
            <div className="h-8 w-32 bg-oatmeal-200 rounded-sm mb-2" />
            <div className="h-12 w-full bg-oatmeal-100 rounded-sm" />
          </div>
        ))}
      </div>
    </div>
