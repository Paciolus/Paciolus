...
const TOOLS: ToolSlide[] = [
  ...
  },
  {
    ...
    valueProposition: 'Upload your fixed asset register and run 10 automated tests covering depreciation accuracy, useful life reasonableness, and residual value anomalies. Pattern analysis catches assets with inconsistent depreciation methods, unusual capitalizations, and items that should have been fully depreciated but carry remaining book value.',
...
const PRICING_TIERS = [
  {
    ...
    price: '$100',
    period: '/mo',
    summary: 'All 18 tools · PDF + Excel + CSV',
    popular: false,
  },
  {
    name: 'Professional',
