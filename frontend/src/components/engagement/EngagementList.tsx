    ...
    <div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-6">
        ...
        <select
          ...
          className="px-3 py-2 bg-surface-input border border-theme rounded-lg text-sm font-sans text-content-secondary outline-hidden focus:border-sage-500/50 transition-colors appearance-none cursor-pointer"
        >
          ...
          {[1, 2, 3, 4].map(i => (
            <div key={i} className="bg-surface-card rounded-xl border border-theme p-5 animate-pulse">
              <div className="flex items-start justify-between gap-3 mb-3">
                <div className="h-5 w-2/3 bg-oatmeal-200 rounded-sm" />
                <div className="h-5 w-16 bg-oatmeal-200 rounded-full" />
              </div>
              <div className="h-4 w-3/4 bg-oatmeal-200 rounded-sm mb-3" />
              <div className="h-4 w-1/2 bg-oatmeal-200 rounded-sm" />
            </div>
          ))}
        </div>
      )}
