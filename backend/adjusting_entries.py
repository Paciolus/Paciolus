...
class AdjustingEntry:
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "entry_total": str(self.entry_total),
...
class AdjustmentSet:
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "total_adjustment_amount": str(self.total_adjustment_amount),
...
class AdjustedAccountBalance:
    ...
    def to_dict(self) -> dict:
        ...
        return {
            "account_name": self.account_name,
            "unadjusted_debit": str(self.unadjusted_debit),
            "unadjusted_credit": str(self.unadjusted_credit),
            "unadjusted_balance": str(self.unadjusted_balance),
            "adjustment_debit": str(self.adjustment_debit),
            "adjustment_credit": str(self.adjustment_credit),
            "net_adjustment": str(self.net_adjustment),
            "adjusted_debit": str(self.adjusted_debit),
            "adjusted_credit": str(self.adjusted_credit),
...
class AdjustedTrialBalance:
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "totals": {
                "unadjusted_debits": str(self.total_unadjusted_debits),
                "unadjusted_credits": str(self.total_unadjusted_credits),
                "adjustment_debits": str(self.total_adjustment_debits),
                "adjustment_credits": str(self.total_adjustment_credits),
                "adjusted_debits": str(self.total_adjusted_debits),
                "adjusted_credits": str(self.total_adjusted_credits),
            },
            "is_balanced": self.is_balanced,
