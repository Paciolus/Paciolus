"""
Paciolus Recon Engine — relocated to per-tool domain package (Sprint 753, ADR-018).
...
Sprint 753 (pilot): full implementation moved here from
`backend/recon_engine.py`. The legacy module remains as a backward-compat
shim re-exporting the public API. New code should import directly from
`services.audit.flux.recon`.
"""
