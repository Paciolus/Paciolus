...
class TestUnusualPaymentAmounts:
    ...
    def _vendor_payments(self, amounts, vendor="Acme Corp"):
        rows = [{"Vendor Name": vendor, "Amount": a, "Payment Date": "2025-01-01"} for a in amounts]
...
class TestHighFrequencyVendors:
    ...
    def test_five_payments_same_day_flagged(self):
        rows = [{"Vendor Name": "Acme Corp", "Amount": 1000 * (i + 1), "Payment Date": "2025-01-10"} for i in range(5)]
        payments = make_payments(rows, ["Vendor Name", "Amount", "Payment Date"])
        config = APTestingConfig()
        result = run_high_frequency_test(payments, config)
    ...
    def test_below_threshold_not_flagged(self):
        rows = [{"Vendor Name": "Acme Corp", "Amount": 1000 * (i + 1), "Payment Date": "2025-01-10"} for i in range(4)]
        payments = make_payments(rows, ["Vendor Name", "Amount", "Payment Date"])
        config = APTestingConfig()
        result = run_high_frequency_test(payments, config)
        assert result.entries_flagged == 0
    ...
    def test_different_days_not_flagged(self):
        rows = [{"Vendor Name": "Acme Corp", "Amount": 1000, "Payment Date": f"2025-01-{10 + i:02d}"} for i in range(5)]
        payments = make_payments(rows, ["Vendor Name", "Amount", "Payment Date"])
        config = APTestingConfig()
        result = run_high_frequency_test(payments, config)
        assert result.entries_flagged == 0
    ...
    def test_high_severity_ten_plus(self):
        rows = [{"Vendor Name": "Acme Corp", "Amount": 100 * (i + 1), "Payment Date": "2025-01-10"} for i in range(10)]
        payments = make_payments(rows, ["Vendor Name", "Amount", "Payment Date"])
        config = APTestingConfig()
        result = run_high_frequency_test(payments, config)
        for f in result.flagged_entries:
    ...
    def test_medium_severity_five_to_nine(self):
        rows = [{"Vendor Name": "Acme Corp", "Amount": 1000 * (i + 1), "Payment Date": "2025-01-10"} for i in range(6)]
        payments = make_payments(rows, ["Vendor Name", "Amount", "Payment Date"])
        config = APTestingConfig()
        result = run_high_frequency_test(payments, config)
        for f in result.flagged_entries:
    ...
    def test_disabled(self):
        rows = [{"Vendor Name": "Acme Corp", "Amount": 1000, "Payment Date": "2025-01-10"} for _ in range(10)]
        payments = make_payments(rows, ["Vendor Name", "Amount", "Payment Date"])
