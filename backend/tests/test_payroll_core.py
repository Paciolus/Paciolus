"""
Tests for Payroll & Employee Testing Engine — Core functionality.

Covers column detection, parsing, safe helpers, data quality,
structural tests (T1-T5), composite scoring, battery orchestration,
full pipeline, and serialization.
