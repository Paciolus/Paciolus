...
def gen_preflight():
    ...
    preflight_result = {
        ...
        "column_count": 7,
        "columns": [
            {"role": "account_name", "detected_name": "Account Description", "confidence": 0.98, "status": "found"},
            {"role": "debit", "detected_name": "Debit Balance", "confidence": 0.95, "status": "found"},
            {"role": "credit", "detected_name": "Credit Balance", "confidence": 0.95, "status": "found"},
            {"role": "account_number", "detected_name": "Acct #", "confidence": 0.88, "status": "found"},
        ...
        "score_breakdown": [
            ...
            {"component": "column_detection", "weight": 0.20, "score": 75.0, "contribution": 15.0},
            {"component": "null_values", "weight": 0.15, "score": 87.5, "contribution": 13.1},
            {"component": "duplicates", "weight": 0.10, "score": 100.0, "contribution": 10.0},
            {"component": "encoding", "weight": 0.05, "score": 100.0, "contribution": 5.0},
            {"component": "mixed_signs", "weight": 0.15, "score": 100.0, "contribution": 15.0},
            {"component": "zero_balance", "weight": 0.10, "score": 75.0, "contribution": 7.5},
        ],
        "issues": [
            {
                "category": "column_detection",
                "severity": "medium",
                "message": "Column detection confidence is moderate (85%) — Currency column not detected, defaulting to USD",
                "affected_count": 247,
                "remediation": "Add a 'Currency' column if multi-currency TB. Verify Account_Type mapping is correct.",
                "downstream_impact": "All diagnostic tools depend on correct column mapping. Currency-dependent tests will default to USD for all 247 accounts.",
                "affected_items": [],
                "affected_items_truncated": False,
                "affected_items_total": 0,
                "tests_affected": 12,
            },
            {
                ...
                "downstream_impact": "Missing values in critical columns produce incomplete trial balance totals, skewed ratio calculations, and may cause accounts to be silently excluded from testing tools.",
                "affected_items": [
                    "4100",
                    "4110",
                    "4120",
                ...
                "affected_items_total": 15,
                "tests_affected": 6,
            },
            {
                "category": "zero_balance",
                "severity": "low",
                "message": "18 rows have zero balance in both debit and credit columns (7% of rows)",
                "affected_count": 18,
                "remediation": "Zero-balance rows add noise to the analysis. Consider filtering them out if they represent closed or inactive accounts.",
                "downstream_impact": "Zero-balance rows add noise to statistical tests (Benford's Law, sampling), inflate account counts, and reduce the signal-to-noise ratio in anomaly detection.",
                "affected_items": [
                    "Closed Account A",
                    "Closed Account B",
                    "Inactive - Supplies",
                    ...
                    "Old Equipment",
                    "Legacy Fund",
                    "Former Tenant Deposit",
                    "Retired Debt",
                    "Expired Prepaid",
                    "Archive Payable",
                ],
                "affected_items_truncated": True,
                "affected_items_total": 18,
                "tests_affected": 4,
            },
            {
                "category": "encoding",
                "severity": "low",
                "message": "2 account names contain non-ASCII characters (0.8% of rows)",
                "affected_count": 2,
                "remediation": "Non-ASCII characters may cause matching issues. Consider normalizing account names to ASCII.",
                "downstream_impact": "Non-ASCII characters can cause account matching failures in lead sheet mapping, classification rules, and cross-period comparisons.",
                "affected_items": ["Café Equipment Lease", "Möbius Capital Reserve"],
                "affected_items_truncated": False,
                "affected_items_total": 2,
                "tests_affected": 3,
            },
        ],
    }
...
def gen_population_profile():
    ...
    # Total = sum of all bucket sums = $12,847,392.50
    # Bucket sums: 17,750 + 387,250 + 2,245,000 + 3,047,392.50 + 7,150,000 = 12,847,392.50
    # Account counts: 36 + 78 + 95 + 35 + 3 = 247
    profile_result = {
        "account_count": 247,
        ...
        "p75": 67_500.00,
        "buckets": [
            {"label": "Zero (<$0.01)", "count": 4, "percent_count": 1.6, "sum_abs": 0.00},
            {"label": "<$1K", "count": 32, "percent_count": 13.0, "sum_abs": 17_750.00},
            {"label": "$1K–$10K", "count": 78, "percent_count": 31.6, "sum_abs": 387_250.00},
            {"label": "$10K–$100K", "count": 95, "percent_count": 38.5, "sum_abs": 2_245_000.00},
            {"label": "$100K–$1M", "count": 35, "percent_count": 14.2, "sum_abs": 3_047_392.50},
            {"label": ">$1M", "count": 3, "percent_count": 1.2, "sum_abs": 7_150_000.00},
        ],
        "top_accounts": [
            {
                "rank": 1,
            ...
            },
            {
                ...
                "account_number": "5000",
                "category": "Expense",
                "net_balance": 1_650_000.00,
                "percent_of_total": 12.8,
            },
            {
                "rank": 3,
                ...
                "account_number": "1500",
                "category": "Asset",
                "net_balance": 1_250_000.00,
                "percent_of_total": 9.7,
            },
            {
                "rank": 4,
                ...
                "account_number": "2300",
                "category": "Liability",
                "net_balance": -875_000.00,
                "percent_of_total": 6.8,
            },
            {
                "rank": 5,
            ...
            },
            {
                ...
                "account_number": "1200",
                "category": "Asset",
                "net_balance": 485_000.00,
                "percent_of_total": 3.8,
            },
            {
                "rank": 7,
            ...
            },
            {
                ...
                "account_number": "2000",
                "category": "Liability",
                "net_balance": -298_000.00,
                "percent_of_total": 2.3,
            },
            {
                "rank": 9,
            ...
            },
            {
                ...
                "account_number": "1000",
                "category": "Asset",
                "net_balance": 215_000.00,
                "percent_of_total": 1.7,
            },
        ],
        # Sprint 511: Account type stratification
        "account_type_stratification": [
            {
                "account_type": "Asset",
                "count": 52,
                "pct_of_accounts": 21.1,
                "total_balance": 3_217_000.00,
                "pct_of_population": 25.0,
            },
            {
                "account_type": "Liability",
                "count": 38,
                "pct_of_accounts": 15.4,
                "total_balance": 1_890_000.00,
            ...
            },
            {
                ...
                "count": 12,
                "pct_of_accounts": 4.9,
                "total_balance": 824_392.50,
                "pct_of_population": 6.4,
            },
            {
                "account_type": "Revenue",
                "count": 28,
                "pct_of_accounts": 11.3,
                "total_balance": 5_325_000.00,
                "pct_of_population": 41.4,
            },
            {
                "account_type": "Expense",
                "count": 117,
                "pct_of_accounts": 47.4,
                "total_balance": 1_591_000.00,
                "pct_of_population": 12.4,
            },
        ],
        # Sprint 511: Benford's Law analysis (shared.benford output format)
        "benford_analysis": {
            "passed_prechecks": True,
            ...
            "most_deviated_digits": [2, 8],
        },
        # Sprint 511: Exception flags
        "exception_flags": {
            "normal_balance_violations": [
                {
                    "account_number": "1210",
            ...
            "zero_balance_accounts": [
                ...
                {
                    "account_number": "7200",
                    "account": "Discontinued Operations",
                    "account_type": "Expense",
                    "balance": 0.00,
                    "is_zero": True,
                },
            ...
            "dominant_accounts": [
                {
                    "account": "Revenue — Consulting Services",
                    "account_number": "4000",
                    "balance": -4_250_000.00,
                    "pct_of_total": 33.1,
                    "risk_note": "Account represents 33.1% of total population value. Apply substantive procedures and obtain management representation.",
                },
                {
                    "account": "Cost of Goods Sold",
                    "account_number": "5000",
                    "balance": 1_650_000.00,
                    "pct_of_total": 12.8,
                    "risk_note": "Account represents 12.8% of total population value. Apply substantive procedures and obtain management representation.",
                },
            ],
        },
        # Sprint 511: Suggested procedures (dynamically generated from findings)
        "suggested_procedures": [
            {
                "priority": "High",
                "area": "Normal Balance Violations",
                "procedure": "3 account(s) carry balances contrary to their expected normal balance. Obtain management explanation and verify intentionality (e.g., contra accounts, reclassifications).",
            },
            {
                "priority": "High",
                "area": "Concentration Risk",
                "procedure": "Gini coefficient of 0.7823 indicates High concentration. Top account (Revenue — Consulting Services) represents 33.1% of population. Apply substantive procedures to accounts exceeding 10% of total population value.",
            },
            {
                "priority": "High",
                "area": "Dominant Accounts",
                "procedure": "2 account(s) exceed 10% of total population value. Perform detailed testing on each dominant account, including independent substantive analytical procedures per AS 2305.",
            },
            {
                "priority": "Low",
                "area": "Zero-Balance Accounts",
                "procedure": "4 zero-balance account(s) identified. Confirm whether accounts should be closed or retained for ongoing activity.",
            },
            {
                "priority": "Low",
                "area": "Near-Zero Accounts",
                "procedure": "2 near-zero account(s) (balance ≤ $100) identified. Evaluate whether these represent stale or orphaned accounts.",
            },
        ],
        # Sprint 511: Data quality score (computed, not hardcoded placeholder)
        "data_quality": {
            "overall_score": 94.8,
            "completeness_score": 100.0,
            "violation_score": 87.4,
            "zero_balance_score": 98.4,
        },
    }
        ...
        "items": [
            {
                ...
                "account_note": "(largest revenue line; total entity revenue = $6,850,000)",
            },
            {
                ...
                "footnote": (
                    "Marketing &amp; Advertising may represent a sub-account within Other Operating "
                    "Expenses ($795,000). Auditor should confirm account hierarchy and verify "
                    "the balance is not double-counted in the expense category analysis (see WP-ECA)."
                ),
            },
            {
                "account": "Cash and Cash Equivalents",
            ...
            },
            {
                ...
                "prior": 520_000.00,
                "current": 680_000.00,
                "delta_amount": 160_000.00,
                "display_percent": "+30.8%",
                "risk_level": "medium",
                "variance_indicators": ["material_change"],
            },
            {
                "account": "Professional Development & Training",
                "type": "Expense",
                "prior": 85_000.00,
                "current": 128_000.00,
                "delta_amount": 43_000.00,
                "display_percent": "+50.6%",
                "risk_level": "medium",
                "variance_indicators": ["percentage_outlier"],
            },
            {
                ...
                "prior": 145_000.00,
                "current": 198_000.00,
                "delta_amount": 53_000.00,
                "display_percent": "+36.6%",
                "risk_level": "medium",
                "variance_indicators": ["material_change"],
            },
            {
                "account": "Rent & Occupancy",
                "type": "Expense",
                "prior": 240_000.00,
                "current": 295_000.00,
                "delta_amount": 55_000.00,
                "display_percent": "+22.9%",
                "risk_level": "medium",
                "variance_indicators": ["material_change"],
            },
            {
