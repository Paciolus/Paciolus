...
- **Honest product language.** All public-facing descriptions of how Paciolus handles data have been reviewed and corrected to accurately reflect what the system does. Customers can trust that what the website and documentation say matches reality.
...
- **Data leakage risk** — Financial content can no longer appear in database tables or application logs, even in edge cases.
